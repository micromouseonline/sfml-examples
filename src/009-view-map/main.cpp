...
float main_map_size = 1000.0f;
float sidebar_width = 300.0f;
float sidebar_height = 600.0f;
float mini_map_size = 300.0f;
...
sf::Vector2f constrain_mouse(float mx, float my, sf::FloatRect& view_port_rect, sf::View& view) {
  ...
  float minX = mini_map_size / 2.0f;
  float maxX = view.getSize().x - mini_map_size / 2.0f;
  float minY = mini_map_size / 2.0f;
  float maxY = view.getSize().y - mini_map_size / 2.0f;
...
int main() {
  ...
  sf::FloatRect mini_map_view_port_rect(main_map_size + 2 * element_space,              //
                                        main_map_size + element_space - mini_map_size,  //
                                        mini_map_size, mini_map_size                    //
  );

  /// This rectangle is the location of the other UI elements
  sf::FloatRect ui_rect(main_map_size + 2 * element_space,  // left
                        element_space,                      // top
  ...
  sf::View mini_map_view(sf::FloatRect(0, 0, mini_map_size, mini_map_size));
